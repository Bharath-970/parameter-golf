...
+ Self-Generated GPTQ Calibration + Score-First TTT (3 steps) + XSA-all
...
7. Self-generated GPTQ calibration for activation-aware quantization (8 seqs x 256 tokens)
8. Score-first causal TTT on last 3 blocks, 3 steps (legal)
"""
